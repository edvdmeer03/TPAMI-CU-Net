...
folder = fullfile('..','Training_dataset');
...
% use as many pairs as we have for both
N = min(numel(filepaths1), numel(filepaths2));
fprintf('Found %d depth files and %d color files -> using %d pairs.\n', ...
        numel(filepaths1), numel(filepaths2), N);
